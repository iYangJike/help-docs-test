...
const githubRepo = (process.env.GITHUB_REPOSITORY || "baidu/").split("/")[1];
...
const config: Config = {
  ...
  tagline:
    "AI-powered bioinformatics platform for life sciences and drug discovery",
  ...
  url: isGithubActions
    ...
    : "https://help-docs-test.readthedocs.io",
  baseUrl: isGithubActions
    ? isUserOrOrgSite
      ? "/"
      : `/${githubRepo}/`
    : "/zh-cn/latest/",
